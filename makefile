...
# AD HOC
test_feature_html:
	${PYTHON} -m pmix.ppp test/files/FQ_BFR5.xlsx -l English -f html -p minimal > output/FQ_BFR5.html
#	${PYTHON} -m pmix.ppp test/files/FQ-generic.xlsx -f html -p minimal > output/FQ-generic.html
test_feature:
	${PYTHON} -m pmix.ppp test/files/FQ_BFR5.xlsx -l English -f doc -p minimal > output/FQ_BFR5.doc
	open output/FQ_BFR5.doc
