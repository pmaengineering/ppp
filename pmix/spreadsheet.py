"""Module defining classes for spreadsheet IO and object-oriented operations

Contains Workbook and Worksheet classes. Main API entry point is Workbook(file)
where file is a string path to the workbook.
